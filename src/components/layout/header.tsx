        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button size="sm" data-analytics="header-cta" data-cta="get-offer" asChild>
              <AnchorLink href="#valuation-form" className="flex items-center" ariaLabel="Get My Valuation">
            ...
            <div className="px-2 pt-2 pb-3 space-y-1 border-t border-trim-silver/20">
              ...
              <div className="px-3 py-2">
                <Button size="sm" className="w-full" data-analytics="mobile-header-cta" data-cta="get-offer" asChild>
                  <AnchorLink href="#valuation-form" className="flex items-center justify-center" ariaLabel="Get My Valuation" onNavigate={() => setIsMenuOpen(false)}>
                    <Zap className="w-4 h-4 mr-2" />
                    Get My Valuation
                  </AnchorLink>
                </Button>
